...
new Sort(new Array(10000).fill(0).map(v => Math.floor(Math.random() * 100) + 1)).mergeSort();
...
console.log(new Sort(new Array(10000).fill(0).map(v => Math.floor(Math.random() * 100) + 1)).quickSort());
