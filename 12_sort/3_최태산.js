...
new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1).sort().reverse()).bubbleSort();
//정렬된게 빠름.


new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1)).selectSort();
new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1).sort().reverse()).selectSort();
//정렬되지 않은게 더 빠름.

new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1)).insertSort();
new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1).sort().reverse()).insertSort();
//정렬되지 않은게 더 빠름.

new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1)).shellSort();
new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1).sort().reverse()).shellSort();
//정렬되지 않은게 더 빠르다. 

new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1)).mergeSort();
new Sort(new Array(1000).fill(0).map(v => Math.floor(Math.random() * 100) + 1).sort().reverse()).mergeSort();
//정렬된게 더 빠르다.
...
console.log(new Sort(new Array(100).fill(0).map(v => Math.floor(Math.random() * 100) + 1).sort().reverse()).quickSort());
console.log('quick sort : ', 'million Seccond : ' + time());
